...
char* facedetect::getHaarFileName(int id){
	switch(id){
		case haarcascade_profileface:
			return "./haarcascade/haarcascade_profileface.xml";
		case haarcascade_frontalface_alt:
			return "./haarcascade/haarcascade_frontalface_alt.xml";
		case haarcascade_frontalface_alt2:
			return "./haarcascade/haarcascade_frontalface_alt2.xml";
		case haarcascade_frontalface_default:
			return "./haarcascade/haarcascade_frontalface_default.xml";
		case haarcascade_frontalface_alt_tree:
			return "./haarcascade/haarcascade_frontalface_alt_tree.xml";
		case haarcascade_eye:
			return "./haarcascade/haarcascade_eye.xml";
		case haarcascade_eye_tree_eyeglasses:
			return "./haarcascade/haarcascade_eye_tree_eyeglasses.xml";
		case haarcascade_fullbody:
			return "./haarcascade/haarcascade_fullbody.xml";
		case haarcascade_lefteye_2splits:
			return "./haarcascade/haarcascade_lefteye_2splits.xml";
		case haarcascade_lowerbody:
			return "./haarcascade/haarcascade_lowerbody.xml";
		case haarcascade_mcs_eyepair_big:
			return "./haarcascade/haarcascade_mcs_eyepair_big.xml";
		case haarcascade_mcs_eyepair_small:
			return "./haarcascade/haarcascade_mcs_eyepair_small.xml";
		case haarcascade_mcs_lefteye:
			return "./haarcascade/haarcascade_mcs_lefteye.xml";
		case haarcascade_mcs_mouth:
			return "./haarcascade/haarcascade_mcs_mouth.xml";
		case haarcascade_mcs_nose:
			return "./haarcascade/haarcascade_mcs_nose.xml";
		case haarcascade_mcs_righteye:
			return "./haarcascade/haarcascade_mcs_righteye.xml";
		case haarcascade_mcs_upperbody:
			return "./haarcascade/haarcascade_mcs_upperbody.xml";
		case haarcascade_righteye_2splits:
			return "./haarcascade/haarcascade_righteye_2splits.xml";
		case haarcascade_upperbody:
			return "./haarcascade/haarcascade_upperbody.xml";
	}
}
